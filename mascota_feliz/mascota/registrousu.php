...
<?php
    $control = "SELECT * From tipo_usuarios WHERE tipo_usuario >= 2";
...
<?php
    if ((isset($_POST["MM_insert"]))&&($_POST["MM_insert"]=="formreg"))
    {
        ...
        $validar ="SELECT * FROM usuarios WHERE id_usuario='$cedula' or user='$usuario'";
       ...
       if ($fila1) {
        ...
        else
        {
           ...
           $insertsql="INSERT INTO usuarios(id_usuario,nombres,apellidos,direccion,telefono,user,password,tipo_usuario) VALUES('$cedula','$nombre','$usuario','$clave','$idusu')";
