...
$sql_tusu = "Select * from usuarios where tipo_usuario=2";
        ...
        <table border="1"class="center" >
            <form name="frm_convis" method="POST" autocomplete="off">
                ...
                <?php
                    ...
                    $sql= "SELECT * FROM visita,usuarios,mascotas_clientes,estados WHERE visita.id_usuario = usuarios.id_usuario and visita.id_est = estados.id_est and mascotas_clientes.cod_masc = visita.cod_masc and visita.id_usuario = '".$_SESSION['id_usuario']."'";
                    $i=0;
                ...
                <tr>
                    ...
                    <td><input name="id_usuario" type="text" value= "<?php echo ($fila['id_usuario']) ?>"><?php echo ($fila['nombres']) ?> <?php echo ($fila['apellidos']) ?></td>  
